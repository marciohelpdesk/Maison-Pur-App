...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'exec.summary.suppliesToRestock': 'Supplies to Restock',
    ...
    'notif.remindersDesc': 'Get reminded 30 min before each job',
    ...
    'notif.disabled': 'Push notifications disabled',
    'notif.blocked': 'Notifications blocked by browser. Enable in browser settings.',
    'notif.notSupported': 'Push notifications not supported on this browser',
    'notif.testSend': 'Send Test Notification',
    'notif.testSending': 'Sending test notification...',
  ...
  pt: {
    ...
    'exec.step.supplies': 'Suprimentos',
    ...
    // Execution - Supplies Audit
    'exec.supplies.title': 'Auditoria de Suprimentos',
    'exec.supplies.subtitle': 'Marque o que está OK, baixo ou acabou na casa',
    'exec.supplies.needRestock': 'item(s) precisam de reposição',
    'exec.supplies.status.ok': 'OK',
    'exec.supplies.status.low': 'Baixo',
    'exec.supplies.status.out': 'Acabou',
    'exec.supplies.remaining': 'Restante',
    'exec.supplies.remainingPlaceholder': 'Qtd restante',
    'exec.supplies.notePlaceholder': 'Observações (marca, tamanho, onde comprar…)',
    'exec.supplies.addItem': 'Adicionar item personalizado',
    'exec.supplies.newItem': 'Novo item',
    'exec.supplies.itemNamePlaceholder': 'Nome do item',
    'exec.supplies.remove': 'Remover da lista',
    'exec.supplies.cat.bathroom': 'Banheiro',
    'exec.supplies.cat.kitchen': 'Cozinha',
    'exec.supplies.cat.laundry': 'Lavanderia',
    'exec.supplies.cat.bedroom': 'Quarto',
    'exec.supplies.cat.general': 'Geral',
    ...
    'exec.summary.shareWhatsApp': 'Compartilhar no WhatsApp',
    ...
    'notif.remindersDesc': 'Seja lembrado 30 min antes de cada trabalho',
    ...
    'notif.enabled': 'Notificações push ativadas!',
    'notif.disabled': 'Notificações push desativadas',
    'notif.blocked': 'Notificações bloqueadas pelo navegador. Ative nas configurações do navegador.',
    'notif.notSupported': 'Notificações push não suportadas neste navegador',
    'notif.testSend': 'Enviar Notificação de Teste',
    'notif.testSending': 'Enviando notificação de teste...',
    'notif.preferences': 'Preferências',
