    ...
    <>
      ...
      <div className="min-h-screen py-4 sm:py-8 px-2 sm:px-4" style={{ background: 'linear-gradient(180deg, #f8f6f1 0%, #f0ede6 100%)', fontFamily: "'Inter', sans-serif" }}>
        <div className="w-full max-w-2xl mx-auto rounded-2xl overflow-hidden" style={{ background: '#ffffff', boxShadow: '0 25px 60px -15px rgba(45, 80, 22, 0.12), 0 4px 20px -5px rgba(0,0,0,0.06)' }}>
          ...
          {/* Green accent top bar — matching invoice */}
          <div style={{ height: 4, background: 'linear-gradient(90deg, #2D5016, #4A7C2E, #6B9B4E)' }} />

          {/* Estimate Notice */}
          <div className="mx-4 sm:mx-8 mt-4 p-3 rounded-xl flex items-center gap-2" style={{ background: 'rgba(45, 80, 22, 0.04)', border: '1px solid rgba(45, 80, 22, 0.15)' }}>
            <AlertTriangle size={14} style={{ color: '#4A7C2E' }} />
            <p className="text-xs font-medium" style={{ color: '#4A7C2E' }}>This is an estimate, not an invoice. Prices may vary.</p>
          </div>

          {/* Centered Logo — larger */}
          <div className="flex justify-center px-4 sm:px-8 pt-4 sm:pt-6 pb-3 sm:pb-4">
            <BrandLogo className="h-16 sm:h-20 object-contain" />
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-0">
              ...
              <div className="sm:text-right">
                ...
                {estimate.estimate_number && (
                  <p className="text-sm font-mono font-semibold mb-2 sm:mb-3" style={{ color: '#2D5016' }}>#{estimate.estimate_number}</p>
                )}
                <div className="space-y-1 text-xs" style={{ color: '#6b7280' }}>
          ...
          <div className="mx-4 sm:mx-8 my-4 sm:my-5 pl-4 py-3 rounded-r-xl" style={{ borderLeft: '3px solid #2D5016', background: 'rgba(45, 80, 22, 0.02)' }}>
            <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: '#2D5016' }}>Prepared For</p>
            ...
            <div className="flex justify-end">
              <div className="w-full sm:w-64 space-y-2">
                ...
                <div className="flex justify-between items-end pt-2" style={{ borderTop: '2px solid #2D5016' }}>
                  <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#2D5016' }}>Estimated Total (USD)</span>
          ...
          <div className="px-4 sm:px-8 pb-4 sm:pb-6">
            <div className="rounded-xl p-4 sm:p-5 text-center" style={{ background: 'linear-gradient(135deg, rgba(45, 80, 22, 0.06), rgba(74, 124, 46, 0.1))', border: '1px solid rgba(45, 80, 22, 0.15)' }}>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: '#2D5016' }}>Questions about this estimate?</p>
